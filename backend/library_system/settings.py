...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-k!e3kc7iw0358h%xautmhcn5k*(we+9w5ym4wugulw(dfq+e$_')
...
# Library System specific settings
LIBRARY_SETTINGS = {
    'MAX_BOOKS_PER_STUDENT': 3,
    'BORROW_PERIOD_DAYS': 14,
    'FINE_PER_DAY': 1.0,  # PGK per day for overdue books
}
